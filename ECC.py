...
def main():
    ...
    q = int("fffffffffffffffffffffffffffffffeffffffffffffffff", base=16) - int("64210519e59c80e70fa7e9ab72243049feb8deecc146b9b1", base=16)
    n = int("ffffffffffffffffffffffff99def836146bc9b1b4d22831", base=16)
    p1 = 3, 10
    p2 = 9, 7
    p3 = int("188da80eb03090f67cbf20eb43a18800f4ff0afd82ff1012", base=16), int("07192b95ffc8da78631011ed6b24cdd573f977a11e794811", base=16)
